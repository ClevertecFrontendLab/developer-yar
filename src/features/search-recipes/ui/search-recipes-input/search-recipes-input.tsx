...
import { searchRecipesInputStyles as styles } from './search-recipes-input.styles';

type SearchRecipesInputProps = {
    searchResultStatus: SearchResultStatus;
};

export const SearchRecipesInput: FC<SearchRecipesInputProps> = ({ searchResultStatus }) => {
    ...
    return (
        <InputGroup {...styles.inputWrapper}>
            <Input
                ...
                {...styles.input(isQueryNotEmpty, searchResultStatus)}
